      ...
      <section className="bg-[#171717] py-14 text-white">
        <div className="mx-auto max-w-[900px] px-5 md:px-8">
          ...
          <p className="mt-4 max-w-[720px] text-sm leading-6 text-[#c3cbc7]">
            Every number below is generated by <code className="rounded bg-black/40 px-1.5 py-0.5 text-white">npm run evaluate:local</code> from the
            versioned synthetic corpus committed in <code className="rounded bg-black/40 px-1.5 py-0.5 text-white">evaluation/cases.json</code>. Nothing on
            this page is hand-written except this sentence.
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-[#a9b4ae]">
            ...
            <span>Evaluated {new Date(String(meta.evaluated_at)).toISOString().slice(0, 10)} at the code state of commit {String(meta.commit).slice(0, 7)} (CI re-runs this gate on every push; the green badge in the README is the current-HEAD proof)</span>
