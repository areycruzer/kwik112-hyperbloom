...
const beats: [string, string][] = [
  ...
  ["0:40 — The solution: Kwik — Know Who Is In Crisis", "Kwik puts AI on the 112 line. When you call, the AI answers instantly — no busy tone. It reads the caller's emotions through measured prosody: the first open, reproducible emotion-aware intake — the benchmark and the code are public."],
  ["1:00 — Multilingual by design", "A caller in Bengaluru may speak any language. Kwik's safety floor covers Hindi, Hinglish and English today — the languages it is built and tested for — and we publish exactly which languages those are."],
